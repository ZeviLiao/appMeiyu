...
import TrainMediaCardL2Item from '../components/TrainMediaCardL2Item';

// create a component
const CourseMediaListL2Screen = ({ navigation, route }) => {
    ...
    let navTo = (opts) => {
        // alert('not ready.')
        navigation.navigate('AllCourseMediaListL3Screen', opts)
    }
                            ...
                            mediaList.map(m => {
                                return (
                                    <View key={m.id}
                                        ...
                                        <TrainMediaCardL2Item opts={cardItemOpts} course={m}
...
export default CourseMediaListL2Screen;
